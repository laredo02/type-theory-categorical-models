...
\usepackage{amsmath, amssymb, amsthm, syntax, tikz, xcolor, forest}
...
\magenta{How can we build every logic gate thus every logical function using if true and false. add reference to normalisation of logical propositions}
